...
<body>
    <div>
        <nav class="navbar fixed-top navbar-expand-md navbar-dark" style="background-color: #ffff99">
                <img src="{{ asset('img/logo2.png') }}" style="height: 40px; margin-left: 50px">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-warning login" href="{{ url('/logout') }}">Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
